...
# MAYBE SET SURVIVAL TO 0 WHEN MISSING:
...
SumS <- data_summary(my_data.Savg, varname = "Survival", groupnames = c("Date_days", "Treatment"))
...
# Line plot
ggplot(data=SumS, aes(Date_days, y=Survival, fill = Treatment, color = Treatment)) + 
